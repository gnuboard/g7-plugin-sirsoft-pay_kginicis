...
- KG 이니시스 간편결제 결제수단을 주문서에서 브랜드 아이콘과 짧은 설명으로 표시할 수 있는 `easy_pay_show_brand_button` 설정을 추가했습니다. 결제수단 텍스트가 데이터 로딩 후 늦게 채워지거나 1020px 전후 좁은 화면에서도 제목과 설명이 총 2줄로 안정적으로 표시되도록 보정했습니다.
